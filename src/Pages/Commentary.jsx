    ...
    return (
        <div className=" bg-purple-100 min-h-screen">
            ...
            <div className="p-6  flex items-center  justify-center relative">
                ...
                <div className="flex flex-col gap-4   bg-transparent border-4 rounded-lg border-white border-b-gray-900 border-b-8 p-5 lg:p-6 lg:max-h-full">

                    <h1 className="text-2xl font-bold text-purple-800 mb-4">Commentary Card Generator</h1>
